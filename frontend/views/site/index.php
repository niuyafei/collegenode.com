...
<nav class="navbar navbar-default navbar-collegenode" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-collegenode-collapse">
        <ul class="nav navbar-nav navbar-right">
            <li>
                <a href="../index.html" class="nav-menu"><small>Home</small></a>
            </li>
            <li>
                <a href="../bangdan_meiguo.html" class="nav-menu"><small>CollegeNode Rankings</small></a>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dLabel">
                    ...
                    <li>
                        <a href="..//SPANISH/index.html" class="color-blue">CollegeNode Spanish</a>
                    </li>
                </ul>
            </li>
            <!--<li>
            ...
            <li>
                <a href="../about.html" class="nav-menu"><small>About us</small></a>
            </li>
            <!--<li>
...
<div class="main-header">
    <div class="container">
        <div class="headline" style="padding-top: 10%;">
            ...
            <p>
                <a class="btn btn-default m-t-10" href="../bangdan_meiguo.html" role="button">Best High Schools in the US</a>
            </p>
            <p>
                <a class="btn btn-default m-t-10" href="../bangdan_biyexinshui.html" role="button">Colleges With Highest Graduate Salaries</a>
            </p>
            <p>
                <a class="btn btn-default m-t-10" href="../bangdan_boshi.html" role="button">Top Ph.D Feeder Colleges</a>
            </p>
        </div>
    </div>
