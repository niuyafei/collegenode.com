...
<div class="col-xs-10">
	...
	<div class="p-20 p-t-0">
		<?php $form = ActiveForm::begin([
			'action' => ['/articles/update?id='.$model['id']],
			'method' => 'post',
			'options' => [
					...
					<div class="row">
						...
						<div class="col-xs-9">
							<select class="form-control" name="Articles[type]">
								...
								<option value="2" <?= $model['type'] == 2 ? "selected" : ""; ?> >视频</option>
							</select>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-xs-9">
							<select class="form-control" name="Articles[language]">
								...
								<option value="2" <?= $model['language'] == 2 ? "selected" : ""; ?> >西班牙语</option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="row case-edit-formwidth">
				<div class="col-xs-6">
					<div class="row">
						...
						<div class="col-xs-9">
							<?php if($model->img): ?>
								<img src="/img/uploads/<?= $model->img; ?>" style="width: 500px;" >
								<p></p>
							<?php endif; ?>
